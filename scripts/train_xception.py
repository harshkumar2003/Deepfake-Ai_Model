...
MODEL_DIR = "models"
MODEL_SAVE_PATH = os.path.join(MODEL_DIR, "xception.pth")

MAX_IMAGES_PER_CLASS = 2500          # 👈 YAHAN CONTROL HAI (real + fake)
BATCH_SIZE = 4
EPOCHS = 2
LR = 1e-4
...
class DeepfakeDataset(Dataset):
    def __init__(self, root_dir, max_per_class):
        ...
        for cls in ["real", "fake"]:
            ...
            images = images[:max_per_class]   # 👈 LIMIT HERE
...
print("✅ Xception model trained and saved at:", MODEL_SAVE_PATH)
