...
# DATA_DIR        = "data/train"
# MODEL_DIR       = "models"
# MODEL_SAVE_PATH = os.path.join(MODEL_DIR, "efficientnet_b0.pth")
...
RESULTS_DIR     = "results"
MODEL_SAVE_PATH = os.path.join(MODEL_DIR, "efficientnet_b0.pth")
METRICS_PATH    = os.path.join(RESULTS_DIR, "efficientnet_b0_metrics.txt")
...
# Apply augmentation transform only to train subset
...
with open(METRICS_PATH, "w") as f:
    f.write("EfficientNet-B0 — Training & Validation Metrics\n")
    f.write("=" * 55 + "\n")
