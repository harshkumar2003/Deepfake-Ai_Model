...
# DATA_DIR        = "data/train"
# MODEL_DIR       = "models"
# MODEL_SAVE_PATH = os.path.join(MODEL_DIR, "shufflenet_v2.pth")
...
# print("\n Starting training — ShuffleNet-V2")
# print("=" * 45)
...
RESULTS_DIR     = "results"
MODEL_SAVE_PATH = os.path.join(MODEL_DIR, "shufflenet_v2.pth")
METRICS_PATH    = os.path.join(RESULTS_DIR, "shufflenet_v2_metrics.txt")
...
with open(METRICS_PATH, "w") as f:
    f.write("ShuffleNet-V2 — Training & Validation Metrics\n")
    f.write("=" * 55 + "\n")
